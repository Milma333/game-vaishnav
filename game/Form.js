class Form {
    ...
    display() {
        ...
        this.next1.position(windowWidth / 2, windowHeight + 100);
        this.next2.position(windowWidth / 2, windowHeight + 300);
        this.next2.style("color:red")
        this.next1.style("font-family:'Gemunu Libre', sans-serif")
        this.next1.style("background-color:cyan")
        this.next1.size(100, 30);
        this.next1.style("border-radius:30px")
        this.next2.style("border-radius:30px")
        this.next2.style("font-family:'Gemunu Libre', sans-serif")
        this.next2.style("background-color:cyan")
        this.next2.size(100, 30);
